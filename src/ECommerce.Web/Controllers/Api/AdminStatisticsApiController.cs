...
public sealed class AdminStatisticsApiController : ApiControllerBase
{
    ...
    [Authorize(Policy = AuthConstants.Policies.AdminOnly)]
    // [AllowAnonymous] // ≤‚ ‘”√
    public async Task<ActionResult<ApiResponse<FileExportDto>>> ExportOrdersAsync(
    ...
    [Authorize(Policy = AuthConstants.Policies.AdminOnly)]
    // [AllowAnonymous] // ≤‚ ‘”√
    public async Task<ActionResult<ApiResponse<FileExportDto>>> ExportInventoryAsync(
