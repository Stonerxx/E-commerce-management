...
public sealed class AddressesApiController : ApiControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<ApiResponse<IReadOnlyList<AddressDto>>>> GetMine(CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<ApiResponse<object?>>> Delete(long addressId, CancellationToken cancellationToken)
    {
    ...
    public async Task<ActionResult<ApiResponse<object?>>> SetDefault(long addressId, CancellationToken cancellationToken)
    {
