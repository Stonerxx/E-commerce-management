...
public interface IOrderService
{
    ...
    Task CancelAsync(long userId, long orderId, string? reason, CancellationToken cancellationToken = default);
    ...
    Task MarkShippedAsync(long orderId, long logisticsId, long operatorId, CancellationToken cancellationToken = default);
}
