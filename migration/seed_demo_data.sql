...
--   3. 演示账号密码统一为 demo123，password_hash 使用 member2 AuthService 的 PBKDF2 格式。
-- ============================================================
...
INSERT INTO SKU (id, product_id, spec_desc, price, original_price, stock, locked_stock, warning_stock, sku_image, status)
VALUES (9004, 9003, '{"规格":"12瓶装","口味":"原味"}', 129.00, 159.00, 25, 0, 30, '/images/demo-coffee-box.jpg', 1);
...
VALUES (9001, 'DEMO202607080001', 9003, 9001, NULL, 0, 3299.00, 0.00, 0.00, SYSDATE + 1, '{"receiverName":"演示收货人A","receiverPhone":"13800009003","province":"上海市","city":"上海市","district":"浦东新区","detailAddress":"张江高科演示路 100 号"}', '待支付演示订单', SYSDATE - 1, SYSDATE - 1);
...
INSERT INTO ORDER_MAIN (id, order_no, user_id, address_id, user_coupon_id, status, total_amount, discount_amount, pay_amount, pay_expire_time, receiver_snapshot, remark, created_at, updated_at)
VALUES (9005, 'DEMO202607080005', 9004, 9003, NULL, 4, 3299.00, 0.00, 0.00, SYSDATE - 15, '{"receiverName":"演示收货人B","receiverPhone":"13800009004","province":"广东省","city":"深圳市","district":"南山区","detailAddress":"科技园演示街 66 号"}', '已取消演示订单', SYSDATE - 16, SYSDATE - 15);
...
INSERT INTO ORDER_STAT_SNAPSHOT (id, stat_date, order_count, paid_count, sales_amount, refund_amount, avg_order_amount, new_user_count)
VALUES (9004, TRUNC(SYSDATE), 2, 1, 748.00, 0.00, 374.00, 0);
